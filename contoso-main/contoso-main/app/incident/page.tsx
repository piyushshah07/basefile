  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full gap-2 lg:mb-0 lg:grid-cols-4 lg:text-left">
        <a
          href="https://horizontal.atlassian.net/servicedesk/customer/portal/3/group/8/create/256"
        ...
        <a
          href="https://horizontal.atlassian.net/servicedesk/customer/portal/3/group/8/create/258"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-75`}>
            Report System Change
          </p>
        </a>

        <a
          href="https://horizontal.atlassian.net/servicedesk/customer/portal/3/group/8/create/255"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://horizontal.atlassian.net/servicedesk/customer/portal/3/group/8/create/257"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
